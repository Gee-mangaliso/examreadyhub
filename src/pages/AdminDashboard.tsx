...
import {
  ...
  ChevronLeft, GraduationCap, Clock, Award, BookOpen
} from "lucide-react";
...
const AdminDashboard = () => {
  ...
  const viewStudent = async (student: Student) => {
    ...
    const { data } = await supabase.rpc("admin_get_student_attempts", {
      _student_id: student.user_id,
    });
        ...
        <div className="min-h-screen flex flex-col bg-background">
          ...
          <main className="flex-1 py-16 px-4">
            <div className="max-w-5xl mx-auto">
              <Button
                variant="ghost"
                onClick={() => { setSelectedStudent(null); setAttempts([]); }}
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex gap-3 mt-2">
                      ...
                      <Badge variant="outline">
                        ...
                        Joined {format(new Date(selectedStudent.created_at), "MMM d, yyyy")}
                      </Badge>
                    </div>
                  </div>
                </div>
              ...
              <div className="bg-card border border-border rounded-lg shadow-card overflow-hidden">
                <div className="px-6 py-4 border-b border-border">
                  <h3 className="font-heading text-lg text-foreground">Quiz History</h3>
                </div>
                {attemptsLoading ? (
                      ...
                      {attempts.map((a) => (
                        <TableRow key={a.attempt_id}>
                          ...
                          <TableCell className="text-muted-foreground text-sm">
                            {format(new Date(a.completed_at), "MMM d, yyyy HH:mm")}
                          </TableCell>
                        </TableRow>
                      ))}
                    </TableBody>
                      ...
                      <TableRow key={student.user_id}>
                        ...
                        <TableCell className="text-sm text-muted-foreground">
                          {student.last_quiz_at
                            ? format(new Date(student.last_quiz_at), "MMM d, yyyy")
                            : "Never"}
                        </TableCell>
